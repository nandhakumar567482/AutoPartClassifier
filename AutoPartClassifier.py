...
loaded_best_model = keras.models.load_model("./model_04-0.91.h5")
...
def predict(img_rel_path):
    ...
    # Label array
    labels = {0: 'Nexon Bevel-gear', 1: 'Nexon bearing ', 2: 'Eco sports clutch', 3: 'Eco sports cylincer', 4: 'Nexon filter', 5: 'Nexon fuel-tank',
              6: 'helical_gear', 7: 'Eco sports piston', 8: 'Nexon rack-pinion', 9: 'Eco sports shocker', 10: 'Nexon spark-plug', 11: 'Eco sports spur-gear', 
              12: 'Eco sports valve', 13: 'Nexon wheel'}
    ...
    def plot_bar_x():
        ...
        plt.show()
    plot_bar_x()
predict("../input/automobilepartsindentification/Automobile-parts/piston/image (1).jpeg")
predict("../input/automobilepartsindentification/Automobile-parts/wheel/image (10).jpeg")